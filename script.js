...
function fill_in_answers(answers) {
    ...
    instrument.innerText = answers['instrument'];
    vehicle.innerText = answers['vehicle'];
    band.innerText = answers['band'];
    ...
    instrument.innerHTML = answers.instrument;  // Change the content of the element in the HTML doc with the id "career" to the "career" value in answers 
    vehicle.innerHTML = answers.vehicle;
    band.innerHTML = answers.band;
}
...
function handle_submission(evt) {
    ...
    var answers = {
        'mash': mash_choice(),
        'instrument': get_answer('instrument'),
        'vehicle': get_answer('vehicle'),
        'band': get_answer('band')
    }
    // Fill in the answers
